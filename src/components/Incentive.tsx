...
const incentives = [
  ...
  {
    name: '24/7 Student Support',
    description: 'Get help anytime during term. Our support team understands student schedules and needs.',
    icon: ClockIcon,
  },
]
                ...
                <div className="sm:flex sm:items-start">
                  <div className="sm:flex-shrink-0">
                    <div className="flow-root">
                      <div className="inline-flex items-center justify-center rounded-xl bg-emerald-50 p-3 shadow-lg ring-1 ring-emerald-100">
                        <incentive.icon className="h-8 w-8 text-emerald-600" aria-hidden="true" />
                      </div>
                    </div>
                  </div>
        ...
        <div className="mt-8 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-4 sm:p-6 text-center">
          <div className="mx-auto max-w-2xl">
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <button className="inline-flex items-center justify-center rounded-full bg-white px-6 py-3 text-base font-medium text-emerald-600 shadow-lg ring-1 ring-emerald-100 hover:bg-emerald-50 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition-all hover:scale-105">
                Learn More
              </button>
            </div>
          </div>
