...
const navigation = {
  ...
  campus: [
    { name: 'About CampusSwap', href: '/about' },
    { name: 'School Partners', href: '/partners' },
    { name: 'Student Stories', href: '/stories' },
    { name: 'Campus Reps', href: '/reps' },
  ],
  legal: [
      ...
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <div className="flex items-center">
              ...
              <span className="text-xl font-bold text-white">CampusSwap</span>
            </div>
            <p className="text-base text-gray-400">
              The trusted marketplace for boarding school students. Buy, sell, and trade with confidence.
            </p>
          ...
          <div className="mt-6 grid grid-cols-2 gap-4 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-base font-medium text-white">Marketplace</h3>
        ...
        <div className="mt-6 border-t border-gray-700 pt-4">
          <p className="text-base text-gray-400 xl:text-center">
            &copy; 2024 CampusSwap. All rights reserved. Built by students, for students.
          </p>
        </div>
      </div>
    </footer>
